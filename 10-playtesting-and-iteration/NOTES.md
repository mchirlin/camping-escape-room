...
### Home Testing
- Test crafting table at home — RFID reads, recipe recognition, sound effects, button
- Test all block tags individually and in grid combinations
- Test read range through table surface material

### Playtest Person
- Wife will do a full walkthrough pretending to be a player
- Can't use daughter — would spoil the game
...
- [ ] Power bank lasts 2+ hours (enough for two runs)
- [ ] Fishing magnet holds the container
- [ ] Creeper falls apart and re-stacks easily
