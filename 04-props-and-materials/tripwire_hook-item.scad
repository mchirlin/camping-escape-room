// tripwire_hook — Minecraft Item Shape 3D Model
// Auto-generated from minecraft/textures/item/tripwire_hook.png
//
...
// ============================================================
// PIXEL MAP — 46 opaque pixels + filled key head for NFC tag
// ============================================================

item_pixels = [
    [3.5,0.0], [3.5,1.0], [3.5,2.0], [3.5,3.0], [3.5,4.0], [3.5,5.0], [4.5,0.0], [4.5,1.0],
    [4.5,2.0], [4.5,3.0], [4.5,4.0], [4.5,5.0], [5.5,0.0], [5.5,1.0], [5.5,2.0], [5.5,3.0],
    [5.5,4.0], [5.5,5.0],
    [5.5,6.0], [5.5,7.0], [5.5,8.0], [5.5,9.0], [5.5,10.0], [5.5,11.0], [5.5,12.0], [6.5,0.0],
    [6.5,1.0], [6.5,2.0], [6.5,3.0], [6.5,4.0], [6.5,5.0], [6.5,6.0], [6.5,7.0], [6.5,8.0],
    [6.5,9.0], [6.5,10.0],
    [6.5,11.0], [6.5,12.0], [7.5,0.0], [7.5,1.0], [7.5,2.0], [7.5,3.0], [7.5,4.0], [7.5,5.0],
    [8.5,0.0], [8.5,1.0], [8.5,2.0], [8.5,3.0], [8.5,4.0], [8.5,5.0]
];
