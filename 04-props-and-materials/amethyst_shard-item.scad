// amethyst_shard — Minecraft Item Shape 3D Model
// Auto-generated from minecraft/textures/item/amethyst_shard.png
//
...
// ============================================================
// PIXEL MAP — 89 opaque pixels
// ============================================================

item_pixels = [
    [0.5,7.0], [0.5,8.0], [0.5,9.0], [0.5,10.0], [1.5,6.0], [1.5,7.0], [1.5,8.0], [1.5,9.0],
    [1.5,10.0], [1.5,11.0], [2.5,5.0], [2.5,6.0], [2.5,7.0], [2.5,8.0], [2.5,9.0], [2.5,10.0],
    [2.5,11.0], [2.5,12.0], [3.5,4.0], [3.5,5.0], [3.5,6.0], [3.5,7.0], [3.5,8.0], [3.5,9.0],
    [3.5,10.0], [3.5,11.0], [3.5,12.0], [4.5,3.0], [4.5,4.0], [4.5,5.0], [4.5,6.0], [4.5,7.0],
    [4.5,8.0], [4.5,9.0], [4.5,10.0], [4.5,11.0], [5.5,2.0], [5.5,3.0], [5.5,4.0], [5.5,5.0],
    [5.5,6.0], [5.5,7.0], [5.5,8.0], [5.5,9.0], [5.5,10.0], [6.5,1.0], [6.5,2.0], [6.5,3.0],
    [6.5,4.0], [6.5,5.0], [6.5,6.0], [6.5,7.0], [6.5,8.0], [6.5,9.0], [7.5,0.0], [7.5,1.0],
    [7.5,2.0], [7.5,3.0], [7.5,4.0], [7.5,5.0], [7.5,6.0], [7.5,7.0], [7.5,8.0], [8.5,0.0],
    [8.5,1.0], [8.5,2.0], [8.5,3.0], [8.5,4.0], [8.5,5.0], [8.5,6.0], [8.5,7.0], [9.5,0.0],
    [9.5,1.0], [9.5,2.0], [9.5,3.0], [9.5,4.0], [9.5,5.0], [9.5,6.0], [10.5,0.0], [10.5,1.0],
    [10.5,2.0], [10.5,3.0], [10.5,4.0], [10.5,5.0], [11.5,0.0], [11.5,1.0], [11.5,2.0], [11.5,3.0],
    [11.5,4.0]
];
