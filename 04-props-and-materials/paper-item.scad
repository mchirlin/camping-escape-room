// paper — Minecraft Item Shape 3D Model
// Auto-generated from minecraft/textures/item/paper.png
//
...
PIXELS          = 15;              // grid divisions (shape-fitted)
...
// ============================================================
// PIXEL MAP — 98 opaque pixels
// ============================================================

item_pixels = [
    [0.0,7.5], [1.0,6.5], [1.0,7.5], [1.0,8.5], [2.0,5.5], [2.0,6.5], [2.0,7.5], [2.0,8.5],
    [2.0,9.5], [3.0,5.5], [3.0,6.5], [3.0,7.5], [3.0,8.5], [3.0,9.5], [3.0,10.5], [4.0,4.5],
    [4.0,5.5], [4.0,6.5], [4.0,7.5], [4.0,8.5], [4.0,9.5], [4.0,10.5], [4.0,11.5], [5.0,3.5],
    [5.0,4.5], [5.0,5.5], [5.0,6.5], [5.0,7.5], [5.0,8.5], [5.0,9.5], [5.0,10.5], [5.0,11.5],
    [5.0,12.5], [6.0,3.5], [6.0,4.5], [6.0,5.5], [6.0,6.5], [6.0,7.5], [6.0,8.5], [6.0,9.5],
    [6.0,10.5], [6.0,11.5], [6.0,12.5], [7.0,2.5], [7.0,3.5], [7.0,4.5], [7.0,5.5], [7.0,6.5],
    [7.0,7.5], [7.0,8.5], [7.0,9.5], [7.0,10.5], [7.0,11.5], [8.0,1.5], [8.0,2.5], [8.0,3.5],
    [8.0,4.5], [8.0,5.5], [8.0,6.5], [8.0,7.5], [8.0,8.5], [8.0,9.5], [8.0,10.5], [8.0,11.5],
    [9.0,1.5], [9.0,2.5], [9.0,3.5], [9.0,4.5], [9.0,5.5], [9.0,6.5], [9.0,7.5], [9.0,8.5],
    [9.0,9.5], [9.0,10.5], [10.0,2.5], [10.0,3.5], [10.0,4.5], [10.0,5.5], [10.0,6.5], [10.0,7.5],
    [10.0,8.5], [10.0,9.5], [11.0,3.5], [11.0,4.5], [11.0,5.5], [11.0,6.5], [11.0,7.5], [11.0,8.5],
    [11.0,9.5], [12.0,4.5], [12.0,5.5], [12.0,6.5], [12.0,7.5], [12.0,8.5], [13.0,5.5], [13.0,6.5],
    [13.0,7.5], [14.0,6.5]
];
